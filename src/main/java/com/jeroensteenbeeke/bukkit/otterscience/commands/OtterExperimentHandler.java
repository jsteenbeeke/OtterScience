...
public class OtterExperimentHandler extends PlayerAwareCommandHandler {
	private OtterSciencePlugin plugin;

	public OtterExperimentHandler(OtterSciencePlugin plugin) {
	...
	public CommandMatcher getMatcher() {
		return ifNameIs("otter").andArgIs(0, "experiment").itMatches();
	}
	...
	public void onAuthorizedAndPlayerFound(Player player, Command command,
		...
		if (player.getWorld().equals(lab)) {
			...
			player.teleport(new Location(l.getWorld(), l.getX(), 122, l.getZ()));
		}
